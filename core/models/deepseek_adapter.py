"""
core/models/deepseek_adapter.py

DeepSeek'in OpenAI uyumlu API'si için adaptör (güçlü, uygun maliyetli
akıl yürütme modeli). Otomatik yedekleme zincirinde kullanılıyor.
...
class DeepseekAdapter(ModelAdapter):
    def __init__(self, model: str = "deepseek-chat", api_key: Optional[str] = None):
        ...
        if not self.api_key:
            raise RuntimeError(
                "DEEPSEEK_API_KEY bulunamadı. Render ortam değişkenlerine eklemen gerekiyor."
            )
